...
- `AW-XXXXXXXXXX` → Your Google Ads Conversion ID (e.g., `AW-123456789`)
...
1. Replace `AW-XXXXXXXXXX` in all HTML files with your real ID
...
find . -name "*.html" -exec sed -i 's/AW-XXXXXXXXXX/AW-YOUR-REAL-ID/g' {} +
